...
var contenedorError = document.getElementById('error-validacion');
function buscarLibros(termino) {
    return __awaiter(this, void 0, void 0, function () {
        var url, response, data, libros, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    url = "https://openlibrary.org/search.json?q=".concat(encodeURIComponent(termino));
...
function renderizarTarjetas(libros) {
    ...
    libros.forEach(function (libro) {
        ...
        var autor = libro.author_name ? libro.author_name.join(', ') : 'Autor desconocido';
        var anio = (_a = libro.first_publish_year) !== null && _a !== void 0 ? _a : 'Año no disponible';
