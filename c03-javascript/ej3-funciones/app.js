...
console.log(`Monto: $100 | Pago: E | Final: $${calcularPrecioFinal(150, "E")}`);
console.log(`Monto: $300 | Pago: E | Final: $${calcularPrecioFinal(250, "E")}`);
console.log(`Monto: $300 | Pago: D | Final: $${calcularPrecioFinal(250, "D")}`);
console.log(`Monto: $300 | Pago: C | Final: $${calcularPrecioFinal(250, "C")}`);
